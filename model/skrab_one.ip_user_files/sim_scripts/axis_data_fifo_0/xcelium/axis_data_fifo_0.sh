...
#
# Script generated by Vivado on Tue Aug 11 19:12:37 -03 2026
...
#                axis_data_fifo_0.sh [-rerun]
#                axis_data_fifo_0.sh [-reset_run]
#                axis_data_fifo_0.sh [-clean]
...
design_libs_elab="-libname xpm -libname axis_infrastructure_v1_1_1 -libname axis_data_fifo_v2_0_17 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm axis_infrastructure_v1_1_1 axis_data_fifo_v2_0_17 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "axis_data_fifo_0.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../ipstatic/hdl" +incdir+"../../../../../../../../../media/valmyrsilva07/243aad91-22c0-42a8-ba29-06c4e186c14c/xmen/Music/2025.2/data/rsb/busdef" \
  ...
  xmvlog -work axis_infrastructure_v1_1_1 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"../../../../../../../../../media/valmyrsilva07/243aad91-22c0-42a8-ba29-06c4e186c14c/xmen/Music/2025.2/data/rsb/busdef" \
  "../../../ipstatic/hdl/axis_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axis_data_fifo_v2_0_17 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"../../../../../../../../../media/valmyrsilva07/243aad91-22c0-42a8-ba29-06c4e186c14c/xmen/Music/2025.2/data/rsb/busdef" \
  "../../../ipstatic/hdl/axis_data_fifo_v2_0_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"../../../../../../../../../media/valmyrsilva07/243aad91-22c0-42a8-ba29-06c4e186c14c/xmen/Music/2025.2/data/rsb/busdef" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/valmyrsilva07/virtex7/skarab-virtex7-toolflow/model/skrab_one.cache/compile_simlib/xcelium"
  fi
...
Usage: axis_data_fifo_0.sh [-rerun]\n\
Usage: axis_data_fifo_0.sh [-reset_run]\n\
Usage: axis_data_fifo_0.sh [-clean]\n\
