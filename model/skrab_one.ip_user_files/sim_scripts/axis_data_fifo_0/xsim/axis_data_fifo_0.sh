...
export RDI_DATADIR="/media/valmyrsilva07/243aad91-22c0-42a8-ba29-06c4e186c14c/xmen/Music/2025.2/data"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L axis_infrastructure_v1_1_1 -L axis_data_fifo_v2_0_17 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axis_data_fifo_0 xil_defaultlib.axis_data_fifo_0 xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/media/valmyrsilva07/243aad91-22c0-42a8-ba29-06c4e186c14c/xmen/Music/2025.2/data/xsim"
  fi
