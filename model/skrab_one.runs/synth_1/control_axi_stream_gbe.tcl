...
namespace eval ::optrace {
  variable script "/home/valmyrsilva07/virtex7/skarab-virtex7-toolflow/model/skrab_one.runs/synth_1/control_axi_stream_gbe.tcl"
...
synth_design -top control_axi_stream_gbe -part xc7vx485tffg1157-1
...
write_checkpoint -force -noxdef control_axi_stream_gbe.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file control_axi_stream_gbe_utilization_synth.rpt -pb control_axi_stream_gbe_utilization_synth.pb"  } 
