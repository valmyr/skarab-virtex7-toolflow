...
HD_PWD='/skarab/projetos/skarab-gbe-control/fpgs/ethernet_one_gbe_skarab_control/ethernet_one_gbe_skarab_axi_fir/myproj/myproj.runs/ethernet_one_gbe_skarab_axi_fir_c_counter_binary_v12_0_i6_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ethernet_one_gbe_skarab_axi_fir_c_counter_binary_v12_0_i6.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ethernet_one_gbe_skarab_axi_fir_c_counter_binary_v12_0_i6.tcl
